    ...
    <div class="row text-center">
        ...
        <div class="col-8">
            <div class="container">
                <div class="row">
                    <div class="col-6">
                        <h5 style="text-align: left; font-size: 30px;">Data Latih</h5>
                    </div>
                    <div class="col-6" style="text-align: right;">
                    <button onclick="window.location.href='tambah_datalatih.php'" type="button" class="btn btn-outline-dark">Tambah Data</button>
                </div>
                </div>
                <br>
                <div class="row">
                    <table class="table table-earnings table-earnings__challenge tableFixHead">
                        <thead>
                            <tr>
                                ...
                                <th class="th-sm">Mata Kuliah Praktikum
                                </th>
                        ...
                        <tbody>
                            <?php $i = 1;
                            while ($result = mysqli_fetch_assoc($actlatih)) { ?>
                                <tr>
                                    <td><?= $i ?></td>
                                    <td><?= $result["mkd_latih"] ?></td>
                                    <td><?= $result["ips_latih"] ?></td>
                                    <td><?= $result["mkp_latih"] ?></td>
                                    <td><?= $result["sas_latih"] ?></td>
                                    <td><?= $result["wp_aktual"] ?></td>
                                    <td><a href="edit_datalatih.php?&id=<?= $result['id_latih']; ?>" class="link" href="">Ubah</a> <a href="hapus_datalatih.php?&id=<?= $result['id_latih']; ?>" class="link" href="">Hapus</a></td>
                                </tr>
                            <?php $i++;
                            } ?>
                        </tbody>
            ...
            <div class="row">
                ...
                <button onclick="window.location.href='hasil_klasifikasi.php'" type="button" class="btn btn-outline-dark" name="submit">Proses Klasifikasi Weighted Naive Bayes</button>
                </div>
            </div>
        </div>
        <div class="col-2">
            ...
            <div class="bg-warning card" style="width: 12rem;">
                <div class="card-body">
                    <p class="card-subtitle mb-2 text-dark">Probabilitas Awal 1S</p>
            ...
            <div class="bg-warning card" style="width: 12rem;">
                <div class="card-body">
                    <p class="card-subtitle mb-2 text-dark">Probabilitas Awal 2S</p>
            ...
            <div class="bg-warning card" style="width: 12rem;">
                <div class="card-body">
                    <p class="card-subtitle mb-2 text-dark">Probabilitas Awal 3S</p>
