...
$query = "SELECT * FROM data_uji ORDER BY id_uji DESC";
...
<body class="bg-secondary text-white" id="page_top">
    ...
    <div class="row text-center">
        ...
        <div class="col-10">
            <div class="container">
                <form method="POST" action="insert_uji.php" class="container d-flex flex-column" style="text-align: left;">
            ...
            <div class="d-grid gap-2 col-2">
                <input type="submit" name="submit" value="Tambah Data Uji" class="btn btn-info"/>
            </div>
            </div>
