    ...
    <div class="row text-center">
        ...
        <div class="col-8">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-6">
                        <h5 style="text-align: left;">Hasil Klasifikasi Data Uji</h5>
                    </div>
                </div>
                <div></div>
                <div class="row">
                    <table class="table table-earnings table-earnings__challenge tableFixHead" style="height: 490px;">
                        <thead>
                            <tr>
                                <th class="th-sm">No
                                </th>
                        ...
                        <tbody>
                            ...
                            while ($dataL = mysqli_fetch_assoc($actuji)) {
                                for ($i = 0; $i < 4; $i++) {
                                    if ($dataL["mkd_uji"] == $a[$i]) {
                                        $mkd1s = $a_mkd1s[$i];
                                        $probmkd1s = pow($mkd1s, 0.145833);
                                    }
                                }
                                for ($i = 0; $i < 4; $i++) {
                                    if ($dataL["ips_uji"] == $a[$i]) {
                                        $ips1s = $a_ips1s[$i];
                                        $probips1s = pow($ips1s, 0.520833);
                                    }
                                }
                                for ($i = 0; $i < 4; $i++) {
                                    if ($dataL["mkp_uji"] == $a[$i]) {
                                        $mkp1s = $a_mkp1s[$i];
                                        $probmkp1s = pow($mkp1s, 0.0625);
                                    }
                                }
                                for ($i = 0; $i < 3; $i++) {
                                    if ($dataL["sas_uji"] == $b[$i]) {
                                        $sas1s = $a_sas1s[$i];
                            ...
                            <?php
                                $query_update = "UPDATE data_uji SET wp_prediksi='" . $prediksi . "' WHERE id_uji=" . $dataL["id_uji"] . "";
            ...
            <div class="row">
                ...
                <button onclick="window.location.href='evaluasi.php'" type="button" class="btn btn-outline-dark" name="submit">Evaluasi Performa</button>
                </div>
            </div>
        </div>
        <div class="col-2">
            ...
            <div class="bg-warning card" style="width: 12rem;">
                <div class="card-body">
                    ...
                    <h1 class="card-title text-dark"><?= count($benar); ?></h1>
                </div>
            </div>
            <br>
            <div class="bg-warning card" style="width: 12rem;">
                <div class="card-body">
                    ...
                    <h1 class="card-title text-dark"><?= count($salah); ?></h1>
                </div>
            </div>
            <br>
            <div class="bg-warning card" style="width: 12rem;">
                <div class="card-body">
                    ...
                    <h1 class="card-title text-dark"><?= round(count($benar) / (count($benar) + count($salah)), 5); ?></h1>
                </div>
            </div>
        </div>
    </div>
